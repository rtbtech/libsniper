...
{
    void clear() noexcept;
    void set(pico::RequestCache::unique&& head, cache::String::unique&& buf_head, cache::String::unique&& buf_body);
...
private:
    pico::RequestCache::unique _head = pico::RequestCache::get_unique_empty();
    cache::String::unique _buf_head = cache::String::get_unique_empty();
    cache::String::unique _buf_body = cache::String::get_unique_empty();
